var imagenames=new Array( 'images/name1.jpg' , 'images/capnews.jpg' , 'images/top.jpg' , 'images/p1.jpg.jpg');
...
var msgg = 'Sit tight, we\'re loading the site!';
...
txt+='<table cellpadding="0" cellspacing="0" border="0"><tr><td valign="center" width="'+barwidth+'" height="'+barheight+'" bgcolor="'+unloadedcolor+'"><center><font color="'+loadedcolor+'" size="1" face="sans-serif">'+ msgg +'</font></center></td></tr></table>';
if(NS4) txt+='</layer>';
...
txt+='<table cellpadding="0" cellspacing="0" border="0"><tr><td valign="center" width="'+barwidth+'" height="'+barheight+'" bgcolor="'+loadedcolor+'"><center><font color="'+unloadedcolor+'" size="1" face="sans-serif">'+ msgg +'</font></center></td></tr></table>';
